package org.abigfish.websocket.controller;

import java.security.Principal;

import org.abigfish.websocket.bean.Message;
import org.abigfish.websocket.bean.Response;
import org.abigfish.websocket.service.WebSocketService;
...
public class WebSocketController {
    ...
    public void handleChat(Principal principal, Message message) {
        ...
        if (principal.getName().equals("admin")) {
            ...
            messagingTemplate.convertAndSendToUser("abigfish",
